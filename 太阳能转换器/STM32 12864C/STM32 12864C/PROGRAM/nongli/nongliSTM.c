...
//月份数据表
static u8 const day_code1[9]={0x0,0x1f,0x3b,0x5a,0x78,0x97,0xb5,0xd4,0xf3};
static u16 const  day_code2[3]={0x111,0x130,0x14e};
...
/*
函数功能:输入BCD阳历数据,输出BCD阴历数据(只允许1901-2099年)    已改输入输出都是10进制
调用函数示例:Conversion(c_sun,year_sun,month_sun,day_sun)
如:计算2004年10月16日Conversion(0,0x4,0x10,0x16);
c_sun,year_sun,month_sun,day_sun均为BCD数据,
c_sun为世纪标志位,
c_sun=0为21世纪,
c_sun=1为19世纪
...
//    day=temp1*10+temp2;
    ...
    //temp1=_cror_(temp1,5);循环右移n: (a<<(N-n))|(a>>n)
		temp1=(temp1<<3)|temp1>>5;
...
无闰月指向12
    ...
    temp1=year/10;
    //temp1=_crol_(temp1,4);//循环左移n: (a>>(N-n))|(a<<n)
		temp1=(temp1>>4)|temp1<<4;
		
    temp2=year%10;
    year_moon=temp1|temp2;
		year_moon=(year_moon/16)*10+year_moon%16;   //16进制转换成10进制
		
    temp1=month/10;
    //temp1=_crol_(temp1,4);//循环左移
		temp1=(temp1>>4)|temp1<<4;		
    temp2=month%10;
    month_moon=temp1|temp2;
		month_moon=(month_moon/16)*10+month_moon%16;    //16进制转换成10进制
    ...
    day_moon=temp1|temp2;
		day_moon=(day_moon/16)*10+day_moon%16;		//16进制转换成10进制
}
/*
***********************************
----------农历程序结束-------------
...
*/
/*************************************************************************
	函数功能:输入BCD阳历数据,输出星期数据(只允许2000-2099年) 
...
/**************************************************************************** 
	...
	星期数为0 
*****************************************************************************/ 
uchar Conver_WEEK(unsigned char year,unsigned char month,unsigned char day) 
{	//21世纪输入输出数据均为10进制数据 
